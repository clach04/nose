"""http://pypi.python.org/pypi/setuptools 0.6c11 modified to add 2.2 support for yield and missing zipimport .
...
def find_on_path(importer, path_item, only=False):
    ...
    try:
        is_access_able = os.access(path_item, os.R_OK)
    except AttributeError:
        is_access_able = True  # guess

    if os.path.isdir(path_item) and is_access_able:
